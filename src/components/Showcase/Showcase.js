...
export default {
    ...
    methods: {
      ...
      getServicesData() {
        axios.get("siteUrl/_api/web/lists/getByTitle('Lst_Services')/items" , {
            headers: {
      ...
      getProjectData: function (listName, idArray) {
        axios.get("siteUrl/_api/web/lists/getByTitle('Lst_" + listName + "')/items" , {
            headers: {
              "Access-Control-Allow-Origin": "*",
              "Content-Type": "application/json",
            }
      ...
      getShowcaseData() {
        axios.get("siteUrl/_api/web/lists/getByTitle('Lst_Showcase-Projects')/items" , {
            headers: {
              "Access-Control-Allow-Origin": "*",
              "Content-Type": "application/json",
            }
