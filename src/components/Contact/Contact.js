...
export default {
    ...
    methods: {
      ...
      getTaglineContent(){
        axios.get("siteUrl/_api/web/lists/getByTitle('Lst_About')/items('2')" , {
            headers: {
            "Access-Control-Allow-Origin": "*",
            "Content-Type": "application/json",
            }
      ...
      getContactDetails(){
        axios.get("siteUrl/_api/web/lists/getByTitle('Lst_Contact-Details')/items" , {
          headers: {
          "Access-Control-Allow-Origin": "*",
          "Content-Type": "application/json",
          }
      ...
      sendItemToList(reqName, reqEmail, reqMessage){
        ...
        return getFormDigest('siteUrl').then(function (data) {
          $.ajax
          ({
            url: "siteUrl/_api/web/lists/getbytitle('Lst_Queries')/items('2')",
            type: "POST",
            data: JSON.stringify
          ({
            __metadata:
